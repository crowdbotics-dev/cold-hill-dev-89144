"""
Django settings for cold_hill_dev_89144 project.
...
ROOT_URLCONF = 'cold_hill_dev_89144.urls'
...
WSGI_APPLICATION = 'cold_hill_dev_89144.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "cold_hill_dev_89144 API",
    "DESCRIPTION": "API documentation for cold_hill_dev_89144 App",
    "VERSION": "v1",
}
